select	max(log_DateTime) MaxLogDT,
					--log_DateTime,
					rct_DepositorID DepositorID, 
					--VehicleNo, 
					rct_ID ReceiptID, rct_Code ReceiptCode, 
					--CompleteDate,
					...
					--sum(rci_ExpQuantity * iucExp.iuc_Conversion) ExpPcsQuantity
					--,manufacturer
					--,RecType
				...
				*/
				...
				group by rct_DepositorID, 
				--VehicleNo, 
				rct_ID, rct_Code, 
				--CompleteDate, 
				--prd_PrimaryCode, prd_SecondaryCode, prdl_Description, loc_Code,
					untlBox.untl_Description, untlBoxEng.untl_Description,
					--, Lsc_SSCC,
					--,untlPal.untl_Description, 
					--,untlPalEng.untl_Description, 
					--,unr_Description, srr_Description,
					lsk_ToStockID, lsk_ProductID, 
					--BaxiSN,BarCode,  
					lsk_UnsuitReasonID, lsk_ReserveReasonID, 
					--spl_Code,
					--cmp_FullName,    
					--Seal,   Posex,
					rct_TypeID   
					--ProdDescr1, all38.all_Value, all15.all_Value, 
					--,untlExpEng.untl_Description
					--,rav4.manufacturer, rav5.RecType
					--, lsa30.Complect
					--,log_DateTime
...
/*
				select * 
from #ReceivedStock
where MaxLogDT > '2024-03-01'

drop table #ReceivedStock*/